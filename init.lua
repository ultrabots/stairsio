...
if( minetest.registered_nodes["default:acacia_wood" ]) then
    stairsio.register_stairsio("acacia", "default:acacia_wood",
...
if( minetest.registered_nodes["default:desert_stone" ]) then
...
if( minetest.registered_nodes["default:desert_cobble" ]) then
...
if( minetest.registered_nodes["default:desert_stonebrick" ]) then
...
if( minetest.registered_nodes["default:brick" ]) then
...
if( minetest.registered_nodes["default:sandstone" ]) then
...
if( minetest.registered_nodes["default:sandstonebrick" ]) then
...
if( minetest.registered_nodes["default:stonebrick" ]) then
...
if( minetest.registered_nodes["default:pinewood" ]) then
...
if( minetest.registered_nodes["default:obsidian" ]) then
...
if( minetest.registered_nodes["default:obsidianbrick" ]) then
